        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 p-0">
                    <div class="boxc pl-lg-50p pr-lg-15p text-center">
...
<section class="investmentSection1">
    ...
    <div class="d-none d-lg-block">
        <style>
            .business-image {position: absolute; z-index: 1030;  width: 70%; height: 60vh;}
            .business-motif1{
                z-index: 1030;
                position: absolute;
                top: 10% !important;
        ...
        <div class="container-fluid pt-lg-5p pb-lg-15p">
            <div class="row">
                ...
                <div class="col-lg-6 pt-lg-5p pl-lg-10p pr-lg-5p pos-rel">
                    <img class="img-fluid business-image" src="<?php the_field('image_section_2') ?>">
                    <!--Motif-->
                    <img class="business-motif1 move-left d-none d-lg-block" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-02.png"/>
                    <img class="business-motif2 move-left d-none d-lg-block" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-03.png"/>

                </div>
                <div class="col-lg-6 pt-lg-10p pl-lg-5p pr-lg-3p">

		    <div id="temptitle-color">
                        <h2><?php the_field('title_content_section_3') ?></h2>    
        ...
        <div class="container-fluid pt-m-5p pb-m-10p">
            <div class="row">
                ...
                <div class="col-12 pb-m-20p pos-rel text-center">
                    ...
                    <!--Motif-->
                    <img class="business-motif1 move-left d-block d-lg-none" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-02.png"/>
                    <img class="business-motif2 move-left d-block d-lg-none" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-03.png"/>
                </div>
		    ...
		    <div id="temptitle-color" class="mt-m-10p">
                    ...
                    <div class="content_sec pt-m-3p pl-m-0 pr-m-0"><?php the_field('content_section_2') ?></div>
                </div>
            </div>
        </div>
    </div>
