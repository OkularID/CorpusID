    ...
    <div class="container-fluid p-0" style="overflow: unset !important;">
        <div class="row">
            ...
            <div class="col-lg-1 pl-lg-0">
                <div class="lang">
                    <a class="font-white mr-lg-10" href="<?php echo home_url('');?>en">EN</a><span class="mr-lg-10">|</span><a class="font-white" href="<?php echo home_url('');?>id">ID</a>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="wa">
                    <div class="text-center">
                        <img src="<?php bloginfo('stylesheet_directory');?>/images/tel.png"><a class="font-white" href="tel:<?php the_field('whatsapp_phone',530) ?>" target="_blank"><?php the_field('whatsapp_title',530) ?></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 pt-m-0 pb-m-0 pl-m-0 pr-m-0">
                    <div class="container-fluid pb-m-5p">
                        <div class="row">
                            <div class="col-10">
                                <a href="<?php echo home_url('');?>"><img class="" src="<?php bloginfo('stylesheet_directory');?>/images/logo-corpus.png" alt=""></a>
                            </div>
                            <div class="col-2">
                                <a class="ham-bars">
                                    <div id="toggle">
                                        <img src="<?php bloginfo('stylesheet_directory');?>/style/img/menu.png" alt="">
                                    </div>
                                </a>
                            </div>
                        </div>
