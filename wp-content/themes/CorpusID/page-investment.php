        ...
        <div class="container-fluid pt-lg-5p pb-lg-10p">
            <div class="row">
                ...
                <div class="col-lg-6 pt-lg-5p pl-lg-10p pr-lg-5p pos-rel">
                    ...
                    <!--Motif-->
                    <img class="investment-motif1 move-left d-none d-lg-block" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-02.png"/>
                    <img class="investment-motif2 move-left d-none d-lg-block" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-03.png"/>
                </div>
                <div class="col-lg-6 pt-lg-10p pl-lg-5p pr-lg-3p">
                    <h2 class="pr-lg-50p"><?php the_field('title_content_section_2') ?></h2>
    ...
    <div class="d-block d-lg-none">
        ...
        <div class="container-fluid pt-m-5p pb-m-10p">
            <div class="row">
                ...
                <div class="col-12 pb-m-20 pos-rel text-center">
                    <img class="img-fluid investment-image" src="<?php the_field('image_section_2') ?>">
                    <!--Motif-->
                    <img class="investment-motif1 move-left d-block d-lg-none" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-02.png"/>
                    <img class="investment-motif2 move-left d-block d-lg-none" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-03.png"/>
                </div>
                <div class="col-12 pt-m-3p">
                    <h2 class="content-title pl-m-5p font-gray"><?php the_field('title_content_section_2') ?></h2>
                    <p class="pt-m-3p content_ pl-m-5p pr-m-5p"><?php the_field('content_section_2') ?></p>
                </div>
            </div>
        </div>
    </div>
