                    ...
                    <div class="container-fluid home-discover pos-rel">
                        <div class="row">
                            <div class="col-lg-12 p-0 slideanim">
                                <div class="boxc">
                                    <a href="<?php the_field('play_link') ?>" target="_blank"><img class="w-lg-15p mb-lg-10p" src="<?php the_field('play_icon') ?>"/></a>
                                    <div class="header-title mb-lg-10p">
                                        <h1 class="font-white"><?php the_field('video_title') ?></h1>
                                        <img class="home-icon-01 d-none d-lg-block" src="<?php bloginfo('stylesheet_directory');?>/images/homepage/home-icon.png"/>
                                        <img class="home-icon-02 d-none d-lg-block" src="<?php bloginfo('stylesheet_directory');?>/images/homepage/home-icon-02.png"/>
                                    </div>
                                    <a class="button-gr" target="_blank" href="<?php the_field('button_link') ?>">
                                        <p class="font-white" target="_blank"><?php the_field('play_button') ?></p>
    ...
    <div class="d-block d-lg-none">
        <style>
            @media screen and (max-width: 846px) {
                ...
                .home-services{background: unset;}
        ...
        <div class="container-fluid pt-m-10p pb-m-10p" style="background: linear-gradient(180deg, #000 85%, #fff 15%);">
            <div class="row">
                <div class="col-12 p-0">
                    <!-- Home Discover -->
                    <div class="container-fluid home-discover pos-rel p-0">
                        <div class="row">
                            <div class="col-12 slideanim">
                                ...
                                <img class="img-fluid d-none d-lg-block" src="<?php bloginfo('stylesheet_directory');?>/images/homepage/home-image-02.jpg"/>
                                <img class="img-fluid d-lg-none service_mobile" src="<?php bloginfo('stylesheet_directory');?>/images/homepage/home-image-02.jpg"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 pt-m-10p">
                    ...
                    <div class="container-fluid home-services pos-rel pt-15p pb-15p">
                        <div class="row">
                            <div class="col-12 pb-m-15p slideanimLeft">
                                ...
                                <ul>
                                    <?php if(have_rows('repeater_section_4')): ?>
                                        <?php while (have_rows('repeater_section_4')): the_row(); ?>
                                            <li><a href="<?php the_sub_field('link_text');?>"><?php the_sub_field('text_title');?></a></li>
                                        <?php endwhile; ?>
                                    <?php endif; ?>
                                </ul>
                                <a href="<?php the_field('link_button_4');?>">
                                    <div class="newbutton-gr" style="background: url('<?php bloginfo('stylesheet_directory');?>/images/button-gr.png');">
                                        <p class="font-white"><?php the_field('button_section_4');?></p>
                                    </div>
                                </a>
                            ...
                            <div class="col-12 text-center">
                                <img class="img-fluid" src="<?php bloginfo('stylesheet_directory');?>/images/homepage/home-image-03.jpg"/>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="collapseOne" class="collapse" data-parent="#accordion">
        <div class="card-body">
            <ul>
                ...
                $commercial = new WP_Query( $params );
			          if($commercial->have_posts()) :
                          while($commercial->have_posts()) : $commercial->the_post();
                              ?>
                              <li><a class="hoverlink" data-img="<?php the_field('images_brief') ?>" href="<?php echo get_permalink(); ?>" rel="<?php the_title(); ?>"><?php the_title(); ?></a></li>
                          <?php
                          endwhile;
                          wp_reset_postdata();
                      endif;
			      	?>
                <li><a class="hoverlink" data-img="<?php the_field('images_sdk') ?>"  href="../sdk">Kawasan Perkantoran Asuransi Astra</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="container-fluid home-contact pos-rel pt-lg-5p pb-lg-10p">
            <div class="row">
                <div class="boxc w-lg-50p text-center">
                    ...
                    <a class="button-gr d-lg-inline" href="<?php the_field('link_button_1_section_7',5) ?>">
                    ...
                    <a class="button-gr d-lg-inline" href="<?php the_field('link_button_2_section_7',5) ?>">
        ...
        <div class="container-fluid home-contact pos-rel pt-m-20p pb-m-20p">
            <div class="row">
                ...
                <div class="col-12 text-right pl-7p pr-7p">
                    ...
                    <div class="boxc w-50p" style="top: 50% !important;">
                        <a class="button-gr d-lg-inline" href="<?php the_field('link_button_1_section_7',5) ?>">
                            <p class="font-white"><?php the_field('button_1_section_7',5) ?></p>
