    ...
    <section class="container-fluid news-detail">
        ...
        <div class="d-none d-lg-block">
            <div class="row">
                <div class="col-lg-12 mb-lg-5p slideanimLeft">
                    <a href="<?php echo home_url('');?>newsroom"><img class="img-fluid" src="<?php bloginfo('stylesheet_directory');?>/images/homepage/arrow-left-box.png"></a>
                    <a href="<?php echo home_url('');?>newsroom">Back</a>
                </div>
        ...
        <div class="d-block d-lg-none">
            <style>
                ...
                .news-detail{padding: 10%;}
            </style>
            <div class="row">
                <div class="col-12 slideanimLeft">
                    <a href="<?php echo home_url('');?>newsroom"><img class="backImg" src="<?php bloginfo('stylesheet_directory');?>/images/homepage/arrow-left-box.png"></a>
                    <a href="<?php echo home_url('');?>newsroom">Back</a>
                </div>
                <div class="col-12 slideanimLeft">
                    <p><?php the_field('date'); ?></p>
                    <h4 class="news-title mb-m-10p"><?php the_title(); ?></h4>
                    <img class="img-fluid w-m-100p mb-m-10p" src="<?php the_field('image'); ?>" alt="">
                    <div>
                        <?php the_field('detail'); ?>
                    </div>
                </div>
