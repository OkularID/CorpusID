        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 p-0">
                    <div class="boxc pl-lg-55p pr-lg-10p text-center">
        ...
        <div class="container-fluid pt-m-5p pb-m-10p">
            <div class="row">
                ...
                <div class="col-12 pb-m-20p pos-rel text-center">
                    <img class="img-fluid investment-image" src="<?php the_field('image_section_2') ?>">
                    <!--Motif-->
                    <img class="restructuring-motif1 move-left d-block d-lg-none" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-02.png"/>
                    <img class="restructuring-motif2 move-left d-block d-lg-none" src="<?php bloginfo('stylesheet_directory');?>/images/investment/partials/partial-03.png"/>
                </div>
